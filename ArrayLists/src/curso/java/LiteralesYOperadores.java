...
public class LiteralesYOperadores {
    public static void main(String[] args) {
        ...
        boolean x25, x26, x27;
        /*public void x222() {*/
            // ver https://docs.oracle.com/javase/tutorial/java/nutsandbolts/operators.html
            ...
            x0 = x0 >> 3; // desplaza los bits de x0 3 lugares a la derecha manteniendo el bit de signo.
            x0 = x0 >>> 3; // desplaza los bits de x0 3 lugares a la derecha insertando ceros por la izquierda.
           ...
           // x17 ^= x25; // cambia el valor de verdad de x17 si x25 es cierto.
            ...
            x0 = 3 + -25 * 17;  // 3 + ((-25) * 17)
           // x0 = (new Bombilla("h")).getPrecio();  // operador . para referenciar campos o métodos a ejecutar.
            ...
            x11.compareTo(x11bis); // Strings (o Comparable<T>). < 0 (x11 < x11bis); == 0 (x11 == x11bis); > 0 (x11 > x11bis);

            // igualdad
            x17 = x0 == x1; // igual
            x17 = x0 != x1; // distinto.
            x17 = x11.equals(x11bis); // igualdad de cadenas/objetos.  Cualquier objeto.
            x17 = x11.equalsIgnoreCase(x11bis); // ignorando mayúsculas/minusculas.
            x17 = "Arriba Cachipurriana".equalsIgnoreCase("ARRIBA CACHIPURRIANA"); // posible notación para string literals.
        }
    }
