...
public class Main {
    ...
    public Main   (int initial) {
        System.out.println(this + ": Constructor con parametro initial=" + initial);
        m_var1 = initial;
    }
    ...
    public static void main( String[] args ) throws InterruptedException {
        ...
        v2.m_var1 = 17;
        p("v1", v1); p("v2", v2);
        v1.var1 = 7;  // esto da un warning porque accedemos al campo estático a través de una instancia (v1).
        p("v1", v1); p("v2", v2);
        v1 = null;
        v2 = null;
        System.gc();
