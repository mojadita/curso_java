...
public abstract class Main {
	...
	/**
	 * Nombres a usar cuando no se proporciona una lista de nombres como argumentos.  El programa debe indicar como
	 * se llama cada {@link Cliente} de los que van a pasar por la {@link Barberia}.
	 */
	...
	public static void main(String[] args) {
		...
		Barbero barbero = new Barbero(NOMBRE_BARBERO, barberia, args.length);
		barbero.start();
