...
public class VerboseSemDijkstra extends SemaforoDijkstra {
    ...
    /**
     * Realiza una operación {@link SemaforoDijkstra#down(int)} ilustrándola con
     * un
     * mensaje al comienzo de la misma, realizado por una {@link Persona} y con
     * un
     * mensaje al finalizar la espera. Se indicará también el tiempo requerido
     * en la
     * espera.
     * 
     ...
     * @return                      el valor del {@link SemaforoDijkstra}, una
     *                              vez la espera ha
     *                              terminado.
     ...
     */
    public int down( Persona who, String before_waiting, String after_waiting )
            throws InterruptedException {
        who.say( before_waiting );
        long ts      = System.currentTimeMillis();
        int  res     = super.down();
        long elapsed = System.currentTimeMillis() - ts;
        who.say( after_waiting + String.format( "  (Duración/espera: %d.%03ds)",
     ...
     * @param  whom    a qué {@link Persona} va dirigida la acción. Lo que se
     *                 dice va
     *                 dirigido a {@code whom}
     * @param  message el mensaje que se le dice a {@code whom}
     * @return         el valor del {@link SemaforoDijkstra} una vez realizada
     *                 la acción.
     */
     ...
     *                 destinatario del mensaje, por tanto no es un mensaje
     *                 dirigido
     *                 a nadie en concreto.
     * @return         el valor ajustado en el {@link SemaforoDijkstra} tras la
     *                 ejecución
     *                 de este método.
     */
     ...
     * @param  message lo que dice la {@link Persona} cuando ha realizado la
     *                 acción.
     *                 No hay destinatario del mensaje, por tanto no es un
     *                 mensaje
