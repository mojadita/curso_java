...
public class MultilevelTreeMap<
        K,
        V> extends TreeMap<K, V> {
     ...
     */
    public MultilevelTreeMap<K, V> getParent() { return m_parent; }
    ...
    public V get( Object clave_de_busqueda ) {
        ...
        if ( value == null && m_parent != null ) // si no existe en este mapa &&
                                                 // hay un parent
    ...
    protected void finalize() {
        ...
        System.out.println( "Soy el map \"" + m_name
                + "\" y me están aniliquilando... 8(" );
    }
