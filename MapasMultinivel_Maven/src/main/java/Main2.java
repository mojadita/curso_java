public class Main2 {
    ...
    public static void b( String key, TonyMapa<String, Number> mapa ) {

        System.out.println( "El saldo Actual del Cliente (\""
                + key + "\") Es de ==> " + mapa.get( key ) + "$" );
    }

    public static void main( String[] args ) {

        TonyMapa<String, Number> globo = new TonyMapa<String, Number>( null );
        TonyMapa<String, Number> globo_hijo
                = new TonyMapa<String, Number>( globo );
         ...
         * a("globo.get(\"Danones_De_Copa\")      <== " + globo.get("")+ "===>"
         * + globo_hijo.get("Danones_De_Copa"));
        ...
        ProductsMap<String, Number> productos
                = new ProductsMap<String, Number>( null );
        ProductsMap<String, Number> productos_hijo
                = new ProductsMap<String, Number>( null );
        System.out.println( "=============================" );
        ...
        System.out.println( "" );
        p( "\"Nike Air\"                            ====================>"
                + productos.get( "Nike Air" ) + "$" );
        p( "\"Sudadera Nike Edition Criminal Crew\" ====================>"
                + productos.get( "Sudadera Nike Edition Criminal Crew" )
                + "$" );
        p( "\"Gorra Nike Blanca\"                   ====================>"
                + productos.get( "Gorra Nike Blanca" ) + "$" );
        p( "\"Nike Air\"                            ====================>"
                + productos.get( "Nike Air" ) + "$" );
        p( "\"Bandolera Nike\"                      ====================>"
                + productos.get( "Bandolera Nike" ) + "$" );
        p( "\"Bandolera Nike\"                      ====================>"
                + productos_hijo.get( "Bandolera Nike" ) + "$" );
        System.out.println( "============================" );
