...
public class Main {
    ...
    public static void herencia1( Shape t ) {
        ...
        // estos métodos estan enlazados con Shape y se ejecutan al iniciar la
        // aplicación.
        t.t();
    ...
    public static void main( String[] args ) { // el main es el corazón de la
                                               // aplicación al desplegar empiza
                                               // a ejecutarse desde aquí Ex:
                                               // Línea 27!

        String Inicio = "SALUDOS";
        String[] Milista = {
            "Rectangulo", "Triangulo", "Circulo", "Line"
        };
        ...
        doStuff( t );
        System.out.println( "===============" );
        System.out.println( "Y guardamos en la Chistera ...." + Milista[3] + ","
                + Milista[1] + "," + Milista[2] );
        Line l = new Line();
        doStuff( l );
        ...
        herencia1( t ); // hay que llamar a la anotación de la función que está
                        // enlazada con la clase principal para que se ejecute
                        // dicho método.
        System.gc(); // que son los que se liberan al llamar al garbage
                     // collector.*/
        herencia1( t );
    }
}
